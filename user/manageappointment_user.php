 ...
 ?>
        <div class="admin-content">
            <div class="button-group">
                <a href="<?php echo SITEURL; ?>user/add-appointment.php" class="btn-big">Add Appointment</a>
            </div>
            <h2 class="page-title">Manage Appointment</h2>
...
<script>
  ...
  document.getElementById("message").style.display = 'none';
    ...
    setInterval(function() {
        $("#refresh").load("loadmanageappointment_user.php");
