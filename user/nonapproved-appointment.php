<?php 
    ...
    $sql = "UPDATE appointment SET App_Status='ApprovedData' WHERE App_ID=$id";
    ...
    if($res==true) {
        ...
        $_SESSION['delete'] = "<div class='success'>Appointment Completed</div>";
        ...
        $_SESSION['delete'] = "<div class='error'>Failed to Completing Appointment</div>";
        //Redirect to Manage Admin Page
        header('location:'.SITEURL.'user/manageappointment_user.php');
    }
