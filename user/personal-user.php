<?php include('partials/menuuser.php'); ?>
    ...
    <form action="" method="">
        <table class="tbl-30">
            ...
            <tr class="tbl">
                <td colspan="2">
                    <a href="<?php echo SITEURL; ?>user/update-personal-user.php?id=<?php echo $id; ?>" class="btn-secondary">Edit</a>
                    <a href="<?php echo SITEURL; ?>user/update-password.php?id=<?php echo $id; ?>" class="btn-primary">Change Password</a>
                </td>
            </tr>
        </table>
        </form>
